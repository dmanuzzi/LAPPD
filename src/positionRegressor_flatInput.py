...
# df.eval('xt1 = xt', inplace=True)
# df.eval('yt1 = yt', inplace=True)
# df.eval('xt2 = -xt - abs(xt)/xt*25', inplace=True)
# df.eval('yt2 = yt', inplace=True)
# df.eval('xt3 = xt', inplace=True)
# df.eval('yt3 = -yt - abs(yt)/yt*25', inplace=True)
# df.eval('max01 = max2',inplace=True)
# df.eval('max02 = max3',inplace=True)
# df.eval('max10 = max1',inplace=True)
# df.eval('max11 = max0',inplace=True)
# df.eval('max12 = max1',inplace=True)
# df.eval('max13 = max0',inplace=True)
# df.eval('max20 = max3',inplace=True)
# df.eval('max21 = max2',inplace=True)
# df.eval('max22 = max3',inplace=True)
# df.eval('max23 = max2',inplace=True)
# df.eval('max31 = max0',inplace=True)
# df.eval('max32 = max1',inplace=True)

# df0 = pd.DataFrame(columns=['x', 'y',          'max01', 'max02', 
